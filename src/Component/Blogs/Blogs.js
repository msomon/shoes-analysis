  ...
  return (
    <div className='blogs'>
      ...
      <p>
        ...
        Some examples of block elements are div and  p tags.Inline elements dont start on a new line, they appear on the same line as the content and tags beside them. Some examples of inline elements are span , strong, and img tags.Inline-block elements are similar to inline elements, except they can have padding and margins added on all four sides. Youll have to declare display: inline-block in your CSS code.
      </p>;
